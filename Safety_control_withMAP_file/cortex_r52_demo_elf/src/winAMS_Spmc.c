...
volatile U2 WinAMS_SPMC_maxCondCnt __attribute__((used)); 
volatile U2 WinAMS_SPMC_maxCondNest __attribute__((used)); 
volatile U1 WinAMS_SPMC_Lock __attribute__((used));
/* v6.3 */
